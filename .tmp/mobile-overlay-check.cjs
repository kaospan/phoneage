  ...
  await page.evaluate(() => {
    ...
    root.innerHTML = `
      <div class="absolute inset-0 z-[70] flex items-center justify-center bg-black/55 px-3 py-2 backdrop-blur-sm sm:px-4">
        <div class="pointer-events-auto max-h-[calc(100svh-1rem)] w-full max-w-xl overflow-y-auto overscroll-contain rounded-[24px] border border-white/15 bg-stone-950/92 p-3 text-stone-50 shadow-2xl sm:rounded-[28px] sm:p-5 md:p-6">
          ...
          <div class="sticky bottom-0 -mx-3 mt-3 flex flex-wrap items-center justify-center gap-2 border-t border-white/10 bg-stone-950/95 px-3 pb-1 pt-3 sm:-mx-5 sm:mt-5 sm:px-5 md:-mx-6 md:px-6">
