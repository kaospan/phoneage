...
export const PuzzleGame = () => {
  ...
  useEffect(() => {
    ...
    arrowSelectHintTimeoutRef.current = window.setTimeout(() => {
      setShowArrowSelectHint(false);
      arrowSelectHintTimeoutRef.current = null;
    }, 4000);
    ...
    return (
      <div className={`relative flex h-[100svh] w-full flex-col overflow-hidden ${isCompact3DView ? 'bg-[#081214]' : 'bg-black'}`}>
        ...
        >
          <div
            className={[
              "overflow-hidden",              isMobilePortrait ? "" : isCompact3DView ? "relative h-full w-full" : "relative h-full w-full rounded-[30px] border border-white/10 shadow-[0_26px_120px_rgba(0,0,0,0.55)]",
