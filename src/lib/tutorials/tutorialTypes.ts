...
export interface TutorialStep {
   ...
   /**
    * When set, this cell is rendered as a crumbling breakable rock during this step,
    * showing the crumble animation that plays when stepping off a breakable rock.
    */
   crumbleCell?: { x: number; y: number };
 }
